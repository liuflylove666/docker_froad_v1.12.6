...
func requestDHCPLease(macaddr, parent string) (net.IP, error) {
...
func dhcpSocket(hwaddr net.HardwareAddr, link netlink.Link) (*dhcp4client.Client, error) {
	logrus.Debugf("lcb-20170222-1001:%v", link.Attrs().Index)
...
//	logrus.Debugf("Releasing lease for container address %s", dl.leaseIP.IP.String())
//
//	logrus.Debugf("lcb-20170221-30001")
...
//func (dp *addrSpace) dhcpDiscoverPool() error {
